...
public class CooperatorRequiredDocumentsTest {
    ...
    public void setMockOutput() {
        ...
        when(docDao.findRequiredDocumentByDueDate((Date) any())).thenAnswer((InvocationOnMock invocation) -> {
        ...
        when(docDao.findRequiredDocumentByCoopPosition((CoopPosition) any())).thenAnswer((InvocationOnMock invocation) -> {
            List<RequiredDocument> result = new ArrayList<RequiredDocument>();
