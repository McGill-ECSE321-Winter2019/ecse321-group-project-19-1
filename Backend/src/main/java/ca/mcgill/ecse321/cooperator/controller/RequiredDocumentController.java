...
public class RequiredDocumentController {
	 ...
	 * @param dueDate the date for which the EmployerContract have to submitted
	 *                before
	 * @param cpId    the Id of the coop position associated with this
	 *                EmployerContract
	...
	/**
	 * Set the grade (accepted or not accepted) of a required document by an
	 * instructor
	 *
	 ...
	 * @return the graded document, or null if any of the instructor or document are
	 *         not found
	 * @throws IllegalArgumentException
	 */
	...
	public RequiredDocumentDto viewRequiredDocument(@RequestParam(name = "documentId") int rdId)
			throws IllegalArgumentException {
